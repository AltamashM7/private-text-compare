...
- **D035 — The canonical production host is `https://compare.amosfot.in/`.** Astro's `site` configuration is the build-time source for canonical/social URL generation; configuring it does not activate DNS or production deployment.
